...
update_hyperparams_logistic_moretrees <- function(X, W, y, 
  ...
  line5 <- sum((a_rho - 1) * expected_l_rho + (b_rho - 1) * expected_l_1m_rho - mapply(lbeta, a_rho, b_rho))
  ...
  line10 <- -1 * sum((a_t_rho - 1) * expected_l_rho + (b_t_rho - 1) * expected_l_1m_rho - mapply(lbeta, a_t_rho, b_t_rho))
