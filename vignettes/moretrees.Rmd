...
First, we load a small simulated dataset, `moretreesCaseCrossover`, which has $n = 1000$ case-crossover pairs, $G = 10$ sparse variable groups containing one to four variables each, and $m = 4$ non-sparse variables including the intercept.
